  ...
  return (
    <div style={{ padding: '24px 16px', maxWidth: 600, margin: '0 auto' }}>
      ...
      <div style={{
        ...
        <div style={{
          width: 56, height: 56, borderRadius: 14, background: '#F5F0EC',
          display: 'flex', alignItems: 'center', justifyContent: 'center',
        }}>
          <SettingsOutlinedIcon sx={{ fontSize: 28, color: '#3E2723' }} />
        </div>
        <p style={{ fontSize: 15, fontWeight: 700, color: '#2B1D1A', margin: 0 }}>Terminal Settings</p>
